			    ...
			    <div class="container">
			        ...
			        <div class="row no-gutters">
			            <div class="col d-flex justify-content-center">
			                <div class="aspect border border-warning rounded-lg align-self-center">
			            ...
			            <div class="col offset-1 d-flex justify-content-center align-items-center flex-column">
			                <h2 class="text-info text-center"><?php echo $bar['bar_name']; ?></h2>
